...
private fun VisibilityChart(
    ...
    BreezyLineChart(
        ...
        persistentListOf(
            persistentMapOf(
                20000f to Color(119, 141, 120),
                15000f to Color(91, 167, 99),
                9000f to Color(90, 169, 90),
                8000f to Color(98, 122, 160),
                6000f to Color(98, 122, 160),
                5000f to Color(167, 91, 91),
                2200f to Color(167, 91, 91),
                1600f to Color(162, 97, 160),
                0f to Color(166, 93, 165)
            )
        ),
