...
private fun WindChart(
    ...
    if (mappedValues.size >= ChartDisplay.CHART_MIN_COUNT) {
        ...
        BreezyLineChart(
            ...
            persistentListOf(
                persistentMapOf(
                    104f to Color(128, 128, 128),
                    77f to Color(205, 202, 112),
                    51f to Color(219, 212, 135),
                    46f to Color(231, 215, 215),
                    36f to colorResource(R.color.windStrength_bf12),
                    30.5f to colorResource(R.color.windStrength_bf11),
                    26.4f to colorResource(R.color.windStrength_bf10),
                    24.475f to Color(109, 97, 163),
                    22.55f to colorResource(R.color.windStrength_bf9),
                    18.9f to colorResource(R.color.windStrength_bf8),
                    17.175f to Color(129, 58, 78),
                    15.45f to colorResource(R.color.windStrength_bf7),
                    13.85f to Color(159, 127, 58),
                    12.25f to colorResource(R.color.windStrength_bf6),
                    9.3f to colorResource(R.color.windStrength_bf5),
                    6.7f to colorResource(R.color.windStrength_bf4),
                    4.4f to colorResource(R.color.windStrength_bf3),
                    2.4f to colorResource(R.color.windStrength_bf2),
                    1.0f to colorResource(R.color.windStrength_bf1),
                    0.0f to colorResource(R.color.windStrength_bf0)
                ),
                persistentMapOf(
                    104f to Color(128, 128, 128, 160),
                    77f to Color(205, 202, 112, 160),
                    51f to Color(219, 212, 135, 160),
                    46f to Color(231, 215, 215, 160),
                    36f to colorResource(R.color.windStrength_bf12).copy(alpha = 160f.div(255f)),
                    30.5f to colorResource(R.color.windStrength_bf11).copy(alpha = 160f.div(255f)),
                    26.4f to colorResource(R.color.windStrength_bf10).copy(alpha = 160f.div(255f)),
                    24.475f to Color(109, 97, 163, 160),
                    22.55f to colorResource(R.color.windStrength_bf9).copy(alpha = 160f.div(255f)),
                    18.9f to colorResource(R.color.windStrength_bf8).copy(alpha = 160f.div(255f)),
                    17.175f to Color(129, 58, 78, 160),
                    15.45f to colorResource(R.color.windStrength_bf7).copy(alpha = 160f.div(255f)),
                    13.85f to Color(159, 127, 58, 160),
                    12.25f to colorResource(R.color.windStrength_bf6).copy(alpha = 160f.div(255f)),
                    9.3f to colorResource(R.color.windStrength_bf5).copy(alpha = 160f.div(255f)),
                    6.7f to colorResource(R.color.windStrength_bf4).copy(alpha = 160f.div(255f)),
                    4.4f to colorResource(R.color.windStrength_bf3).copy(alpha = 160f.div(255f)),
                    2.4f to colorResource(R.color.windStrength_bf2).copy(alpha = 160f.div(255f)),
                    1.0f to colorResource(R.color.windStrength_bf1).copy(alpha = 160f.div(255f)),
                    0.0f to colorResource(R.color.windStrength_bf0).copy(alpha = 160f.div(255f))
                )
            ),
